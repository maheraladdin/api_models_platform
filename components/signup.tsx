        ...
        <DialogContent noCloseButton className={"min-w-[50vw] w-full bg-light pb-12"}>
            <DialogHeader className={"flex justify-center flex-col items-center px-16"}>
                <Image
                    ...
                    alt={"logo"}
                />
                <DialogTitle className={"w-full font-bold text-blue-dark text-4xl pb-5"}>Sign up</DialogTitle>
            ...
            <div className={"px-16 py-2 "}>
                <Form {...form}>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Button type={"submit"} className={"bg-red-dark text-white w-full hover:bg-red-dark/90 hover:text-white"}>Create
                            account</Button>
                        <div className={"text-center text-sm text-black mt-4"}>
                            Already have an account? <span onClick={() => setLogin(true)}
                                                           className={"text-red-dark font-bold hover:underline select-none cursor-pointer"}>login</span>
                        </div>
                    </form>
                </Form>
            </div>
